...
def import_fge_runs(file_path):
    try:
        ...
        persist(result, 'Refinitiv\\Aframax', "Refinitiv_Aframax", 'STG_Targo', "import", 'Refinitiv_Aframax', "Uploaded", 0)

        log("Refinitiv_Aframax", "import_Refinitiv_Aframax", "The job has completed", level='Info', email=True, emailSubject="Refinitiv Aframax")
    except Exception as e:
        error_email("Refinitiv Aframax", "import_Refinitiv_Aframax", str(e) )
...
if(__name__ == "__main__"):
    import_fge_runs("C:/dev/Excel Files/Refinitiv/Aframax/Aframax Floating Storage- 20200612 (beta).xlsx")
