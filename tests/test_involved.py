...
class CSVIntegratorCase(unittest.TestCase):
    ...
    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_ieaSupplyIntegrator
    def test_run_ieaSupplyIntegrator(self):
        ieaSupplyIntegrator.run(os.path.join(ieaSupplyIntegrator.file_path, 'Supply.txt'))

    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_ieaStockdatIntegrator
    ...
    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_ieaExportDataIntegrator
    ...
    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_ieaImportDataIntegrator
    ...
    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_ieaProdDataIntegrator
    ...
    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_ieaFieldIntegrator
    def test_run_ieaFieldIntegrator(self):
        ieaFieldIntegrator.run(os.path.join(ieaFieldIntegrator.file_path, 'field_by_field.csv'))

    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_ieaCountryDetailsIntegrator
    ...
    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_ieaFieldDetailsIntegrator
    ...
    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_rystad
    def test_run_rystad(self):            
     ...
     # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_mcQuilling
    def test_run_mcQuilling(self):            
        mcQuillingIntegrator.run(os.path.join(mcQuillingIntegrator.file_path, 'McQuilling_20191230.csv'))

    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_SGTBrentCrude
    def test_run_SGTBrentCrude(self):            
        SGTBrentCrude.run(os.path.join(SGTBrentCrude.file_path, 'ICE 1630 SGT Brent Crude Futures curve on 14-Jan-20_20200114.csv'))

    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_SGTLSGasOil
    def test_run_SGTLSGasOil(self):            
        SGTLSGasOil.run(os.path.join(SGTLSGasOil.file_path, 'ICE 1630 SGT LS Gas Oil Futures curve on 14-Jan-20_20200114.csv'))

    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_LSGasOil1930
    def test_run_LSGasOil1930(self):
        
        LSGasOil1930.run(os.path.join(LSGasOil1930.file_path, 'ICE 1930 LS Gas Oil Futures curve on 13-Jan-20_20200113.csv'))

    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_WTICrude
    def test_run_WTICrude(self):
       
        WTICrude.run(os.path.join(WTICrude.file_path, 'ICE 1630 WTI Crude Futures curve on 13-Jan-20_20200113.csv'))

    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_HeatingOil
    def test_run_HeatingOil(self):
        
        HeatingOil.run(os.path.join(HeatingOil.file_path, 'ICE 1630 Heating Oil Futures curve on 13-Jan-20_20200113.csv'))

    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_RBOB
    def test_run_RBOB(self):
        
        RBOB.run(os.path.join(RBOB.file_path, 'ICE 1630 (RBOB) Gasoline Futures curve on 21-Jan-20_20200121.csv'))

    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_BrentCrude1630
    ...
    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test_run_clipperFloatingStorage
    ...
    # python -m unittest test_CsvIntegrator.CSVIntegratorCase.test__arrangeColumns__
